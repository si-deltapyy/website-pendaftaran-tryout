...
<body>
    ...
    <nav id="navigation" class="navbar navbar-inverse navbar-fixed-top" role=navigation"">
        <div class="container">
            <div class="navbar-header">
                ...
                <a data-scroll href="#header" class="navbar-brand"><img src="https://i.ibb.co/c3CgSMh/logo-genius.png" class="img-circle" alt="Logo"></a>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-5 pengumuman">
                    <img class="banner-pengumuman" src="img/login-img.png" alt="">
                    <h4><b>Peringkat 3 terbaik</b></h4>
                    <p>Perolehan peringkat tryout 3 besar</p>
                    <button class="btn btn-primary"><a style="color: azure;" href="register.php">Lihat</a></button>
                </div>
                <div class="col-md-5 pengumuman">
                    <img class="banner-pengumuman" src="img/login-img.png" alt="">
                    <h4><b>Peringkat 3 terbaik</b></h4>
