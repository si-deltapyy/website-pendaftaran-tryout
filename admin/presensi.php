<?php
    ...
    echo '<script>alert("Ingat Halaman ini Hanya untuk Daftar Ulang dan Verifikasi pada saat dilaksananakan Try Out")</script>';
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="font-size-16"><a href="auth-user.html"><i class="mdi mdi-backspace text-dark"></i></a> Presensi Peserta</h4>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="card bg-success">
                                    <div class="card-body">
                                        <div class="mb-1">
                                            <h5 class="card-title text-center text-white">Hadir</h5>
                                        </div>
                                        <div class="align-items-center">
                                            <div class="col-12 mb-n4">
                                                <h3 class="text-white text-center">
                                                    <?php
                                                        $present = mysqli_query($conn, "SELECT * FROM tb_peserta where isHadir=1");
                            ...
                            <div class="col-6">
                                <div class="card bg-danger">
                                    <div class="card-body">
                                        <div class="mb-1">
                                            <h5 class="card-title text-center text-white">Tidak Hadir</h5>
                                        </div>
                                        <div class="align-items-center">
                                            <div class="col-12 mb-n4">
                                                <h3 class="text-white text-center">
                                                <?php
                                                        $absent = mysqli_query($conn, "SELECT * FROM tb_peserta where isHadir=0");
                                                        $absentRow = mysqli_num_rows($absent);
                                                        echo $absentRow;
                                                    ?>
                                                </h3>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table style="width: 100%;" id="basic-datatable" class="table dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $dataPresensi = mysqli_query($conn, "SELECT * FROM tb_peserta tp JOIN tb_sekolah ts
                                                ON ts.id=tp.namaSekolah where isHadir=0");
                                                foreach ($dataPresensi as $dp){
                                                ?>
                                                <tr>
                                                    <td><?php echo $dp['id'] ?></td>
                                                    <td><?php echo $dp['name'] ?></td>
                                                    <td><?php echo $dp['nm_sekolah'] ?></td>
                                                    <td>
                                                        <a href="absen.php" class="btn btn-confirm btn-success"> Hadir </a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
