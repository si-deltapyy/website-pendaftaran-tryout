<?php
    include 'db.php';
    $peserta = mysqli_query($conn, "SELECT * FROM tb_peserta");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="font-size-16">Data Peserta Tryout</h4>
                                        ...
                                        <table style="width: 100%;" id="basic-datatable" class="table dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td><?php echo $x["namaSekolah"]?></td>
                                                        <td><a href="https://wa.me/<?php echo $x["noWA"]?>"><?php echo $x["noWA"]?></a></td>
                                                        <td><?php echo $x["statusPeserta"]?></td>
                                                    <td>
                                                        <a href="cek.php?id=lihatDP&user=<?php echo $x['id']?>" class="btn btn-confirm btn-info"><i class="mdi mdi-eye"></i></a>
                                                        <a href="cek.php?id=deleteDP&user=<?php echo $x['id']?>" class="btn btn-confirm btn-danger"><i class="mdi mdi-close-circle"></i></a>
                                                    </td>
                                                </tr>
                                                    <?php }
                                                    ?>
