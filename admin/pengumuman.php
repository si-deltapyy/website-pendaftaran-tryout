                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Upload Pengumuman </h4><br><br>
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="" id="textarea" cols="30" rows="10"></textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label for="simpleinput">Upload File</label>
                                                    <input type="file" id="simpleinput" class="form-control" placeholder="Enter your text">
                                                </div>
