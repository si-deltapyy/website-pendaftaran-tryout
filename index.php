...
<head>
    ...
    <!-- <img src="https://i.ibb.co/c3CgSMh/logo-genius.png" alt="logo-genius" border="0"> -->
    ...
    <nav id="navigation" class="navbar navbar-inverse navbar-fixed-top" role=navigation"">
        ...
        <div class="navbar-collapse collapse navbar-primary" role="navigation">
            <ul class="nav navbar-nav navbar-left">
                <li class="active"><a href="index.php"><span class="fa fa-home" aria-hidden="true"></span> BERANDA</a></li>
        ...
        <div class="box">
            <div class="rows">
                ...
                <div class="isi">
                    ...
                    <p>Sebelum melakukan register, sebaiknya Anda menyimak prosedur register peserta baru di halaman <a href="informasi-prosedur.html" class="link-jumbotron"><b> Prosedur register. </b></a></p>
                    <p>Semua informasi terbaru mengenai Pendaftaran GABUS 2024 bisa Anda lihat di halaman <a href="pengumuman.php" class="link-jumbotron"><b> Pengumuman. </b></a></p>
                    <p>Apabila anda sudah memahami prosedur pendaftaran, silahkan klik tombol <a href="index.php" class="link-jumbotron"><b> "Daftar" </b></a> di bawah ini.</p>

                    <button class="btn btn-primary btn-signin"><a style="color: azure;" href="register.php">Daftar</a></button>
                </div>
